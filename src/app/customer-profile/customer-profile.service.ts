...
export class CustomerProfileService {
  ...
  getCustomerIndividualData(id: string, type: any) {
    return this.http.get(`/remittance/individualCustomerController/getIndividualCustomerDetailsList`, {
  ...
  getCustomerCorporateData(id: string, type: any) {
    return this.http.get(`/remittance/cooperateCustomerController/getCooperateCustomerDetailsList`, {
      headers: new HttpHeaders()
        .set("userId", id)
        .set("individual", type)
    });
